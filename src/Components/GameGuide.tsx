...
const guides = [
  {
    ...
    items: [
      {
        title: "絵文字ミックスの基本",
        description: "絵文字ミックス機能で、まずは感情系の絵文字同士を組み合わせてみましょう。例えば「😊 + 😴」で眠そうな笑顔に！",
        tips: ["絵文字キッチンを活用", "似た表情の組み合わせから始める", "季節の絵文字で旬な表現を"]
      },
      {
        title: "おすすめの使い方",
  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        ...
        >
          絵文字ミックスを使いこなそう！初心者から上級者まで楽しめる完全ガイド
        </Typography>
        ...
        >
          絵文字ミックスの世界は無限大！
          このガイドを参考に、革新的な技術を活用して、あなただけの素敵な組み合わせを見つけてください。
