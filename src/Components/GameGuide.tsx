...
const guides = [
  {
    ...
    items: [
      {
        title: "Google絵文字ミックスの基本",
        description: "Googleが開発した絵文字ミックス機能で、まずは感情系の絵文字同士を組み合わせてみましょう。例えば「😊 + 😴」で眠そうな笑顔に！",
        tips: ["Googleの絵文字キッチンを活用", "似た表情の組み合わせから始める", "季節の絵文字で旬な表現を"]
      },
      {
        title: "おすすめの使い方",
  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        ...
        >
          Google提供の絵文字ミックスを使いこなそう！初心者から上級者まで楽しめる完全ガイド
        </Typography>
        ...
        >
          Google絵文字ミックスの世界は無限大！
          このガイドを参考に、Googleの技術を活用して、あなただけの素敵な組み合わせを見つけてください。
          絵文字ミックスで、コミュニケーションをもっと楽しく、もっと豊かに。
        </Typography>
      </Container>
    </Box>
  );
